...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\linewidth]{images/estadodelarte/noclosefriends.png}
...
Meetup publicó su primer informe, denominado "State of Friendships", donde revela estadísticas globales e insights sobre hobbies, intereses y la formación de nuevas amistades.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\linewidth]{images/estadodelarte/stravaclubs.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\linewidth]{images/estadodelarte/stravaposts.jpeg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\linewidth]{images/estadodelarte/stavachallenges.jpeg}
...
manera espontánea. A diferencia de las aplicaciones de redes sociales tradicionales, que a menudo se centran en perfiles en línea y contenido curado, Amigos Social busca cerrar la brecha entre las interacciones en línea y los encuentros en persona.
